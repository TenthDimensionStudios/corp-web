...
class Top extends Component {
    ...
    componentDidMount() {
        ...
        axios
            .all(promises)
            .then(axios.get("/data/languajes.json").then(function (response) {
    ...
    render() {
        var collapseCName = this.state.selected
            ? "languageMenu row animated fadeInDown collapse"
            : "languageMenu row animated fadeInDown ";
        ...
        return (
            <div id="top" className="header col-md-12">
                <div className="vert-text">
                    ...
                    <a href="#services">
                        <img
                            src="img/logo_Tenth_white.png"
                            className="logoTenth animated fadeInDown"
                            alt="Tenth Dimension Studios Logotype"/>
                    </a>
