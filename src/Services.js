                    ...
                    <div className="col-md-12 col-xs-12 row">
                            ...
                            <div className="service-item">
                                ...
                                <p>
                                    <a
                                        ...
                                        href="https://isolandimension.com/ErebusEngine.html">{this.props.translate.cogsVisit}</a>
                                </p>
                            </div>
                        </div>
                        <div className="col-md-6 featuredContent text-center">
                            <div className="service-item">
                                ...
                                <p>
                                    <a href="https://isolandimension.com">{this.props.translate.starVisit}</a>
                                </p>
                            </div>
                        </div>
                        <div className="col-md-3 text-center">
                    ...
                    <div className="col-md-12 col-xs-12 row">
                        ...
                        <div className="col-md-6 text-center">
                            <div className="service-item">
                                ...
                                <p>
                                    <a className="service-link" href="http://isolandimension.com/ErebusEngine.html">{this.props.translate.cloudVisit}</a>
                                </p>
                            </div>
                        </div>
                        <div className="col-md-6 text-center">
