...
class Portfolio extends Component {
    ...
    render() {
        ...
        if (this.props.translate.mainProjectDetails) {
            ...
            for (var i = 0; i < num; i++) {
                rows.push(
                    <li key={GetID()}>{this.props.translate.mainProjectDetails[i]}</li>
                );
            }
        }
                            ...
                            <div className="col-md-4">
                                ...
                                <ul>
                                    ...
                                    <li className="webLink">
                                        <a href={this.props.translate.mainProjectLink}>{this.props.translate.mainProjectLinkText}</a>
                                    </li>
                                </ul>
                                <button
                                ...
                                })}>{this.props.translate.mainProjectAsk}</button>
                            </div>
                        </div>
