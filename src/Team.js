...
class TeamMemberSocial extends Component {
    render() {
        return (
            <a
                href={this.props.lnk.page}
                target="_blank"
                className={this.props.lnk.alt}
                alt={this.props.lnk.alt}>
    ...
    render() {
        ...
        return (
            <div className="col-md-3 col-xs-6 colaborator text-center">
                ...
                <img
                    className="img-fluid rounded-circle front margin0auto"
                    src={"img/" + this.props.colab.img}
                    alt="..."/>
                ...
                <div className="col-md-12 text-center">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-3 col-xs-6 colaborator text-center">
                            ...
                            <img
                                className="img-fluid rounded-circle front margin0auto"
                                src="img/blank_foto.jpeg"
                                alt="..."/>
                            <h3 className="sansationLightRegular">{this.props.translate.teamAdd}</h3>
                            <p className="sansationLightRegular descUser">
                                <a className="whiteLink" href="#contact">{this.props.translate.teamAddInfo}</a>
                            </p>
                        </div>
                    </div>
                </div>
